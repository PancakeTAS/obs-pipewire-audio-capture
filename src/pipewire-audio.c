								...
								obs_source_t *stream_output)
{
	...
	pw->audio.stream =
		pw_stream_new(pw->core, obs_source_get_name(stream_output),
					  pw_properties_new(PW_KEY_NODE_NAME, obs_source_get_name(stream_output), PW_KEY_NODE_DESCRIPTION, "OBS Studio",
